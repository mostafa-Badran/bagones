        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <textarea name="" id="" cols="30" rows="10" name="description" required class="form-control"
                ...
                <div class="col-lg-4">
                    ...
                    <textarea name="" id="" cols="30" rows="10" name="description_lcoale" required class="form-control"
