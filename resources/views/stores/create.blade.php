        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input type="text" name="name" required class="form-control" placeholder="Enter Store Name" />
                    <span class="form-text text-muted">Please enter Name</span>
                </div>

                <div class="col-lg-4">
                    <label>Name locale<span class="text-danger">*</span></label>
                    <input type="text" name="name_locale" class="form-control" placeholder="Enter Store Locale Name" />
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input type="text" name="slogan" required class="form-control" placeholder="Enter Store Slogan" />
                    <span class="form-text text-muted">Please enter Slogan</span>
                </div>

                <div class="col-lg-4">
                    <label>Slogan locale<span class="text-danger">*</span></label>
                    <input type="text" name="slogan_locale" class="form-control"
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input type="text" name="location_text" required class="form-control"
                ...
                <div class="col-lg-4">
                    ...
                    <input type="text" name="location_text_locale" class="form-control"
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input type="text" name="delivery_time_range" required class="form-control"
