...
<div class="card card-custom example example-compact">
    ...
    @endif
    <!--begin::Form-->
    <form action="{{ url('compulsory_choice/update',$compulsory_choice) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" name="name_locale" required class="form-control" placeholder="Enter Local Name"
                        value="{{ $compulsory_choice->name_locale }}" />
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="component-info">
                        @if($compulsory_choice->entries()->count() > 0)
                            @foreach( $compulsory_choice->entries as $index=>$entry )
