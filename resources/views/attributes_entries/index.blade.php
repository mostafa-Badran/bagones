    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Attributes Entries
                    <div class="text-muted pt-2 font-size-sm">All Attributes Entries Datatable</div>
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ url('attribute_entry/create') }}" class="btn btn-primary font-weight-bolder">
            ...
            var table = $('.main_datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'attribute', name: 'attribute'},
                    {
                        ...
                        {
                            var show_url = "{{ URL::to('/attribute_entry') }}/"+data;
                            var edit_url = "{{ URL::to('/attribute_entry/edit') }}/"+data;
        ...
        $('body').on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type:"POST",
                        url: "{{ url('attribute_entry/delete') }}",
                        data:{
                            'id': id,
                            '_token': '{{ csrf_token() }}',
                        },
