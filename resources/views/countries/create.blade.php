        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input type="text" name="iso" required class="form-control" placeholder="Enter ISO"/>
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input type="number" name="phone" required class="form-control" placeholder="Enter Phone"/>
